...
<body>
   ...
   <div class="header_section">
      <div class="container-fluid header_main">
         <nav class="w-100 navbar navbar-expand-lg navbar-light bg-light">
            <a class="logo" href="index.php"><img src="./images/Logo.png" height="80%" width="30%"></a>
   ...
   <!-- <div class="tag_section layout_padding">
      <div class="container">
         ...
         <div class="tag_bt">
            <ul>
               <li class="active bg-info"><a href="#">Miscellaneous</a></li>
      ...
      <div class="container">
         <div class="row">
            <div class="col-md-6">
               ...
               <?php  } else { ?>
                  <form class="ms-auto" action="insert.php" method="POST" enctype="multipart/form-data">
                     <div class="mail_section" id="contact">
   ...
   <div class="footer_section layout_padding">
      <div class="container">
         <div class="footer_logo"><a href="index.php" class="text-white h2">MyBlog.com</a></div>
         <div class="contact_menu">
            <ul>
               <li><a href="#"><img src="images/call-icon.png"></a></li>
               <li><a href="#">Call : 6756754778</a></li>
               <li><a href="blog.html"><img src="images/mail-icon.png"></a></li>
               <li><a href="features.html">MyBlog_007@gmail.com</a></li>
            </ul>
         </div>
      </div>
   </div>
   ...
   <div class="copyright_section">
      <div class="container">
         <p class="copyright_text">Copyright 2022 All Right Reserved By @Kamal@_007.com</a></p>
      </div>
   </div>
