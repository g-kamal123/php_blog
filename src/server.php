...
function showPosts($page)
{
  ...
  try {
    ...
    if (count($rows) > 0) {
      foreach ($rows as $val) {
        $txt .= '
          <div class="d-flex flex-column align-items-center justify-content-center col-lg-12 col-sm-12  mx-0 my-2 border px-3 py-4"  style="border-radius:25px;background-color:#E7E9EB">
                        <div class="about_img"><img style="margin-left: 15%; margin-right: 15%; width: 70%" src="uploads/' . $val['image'] . '"></div>
