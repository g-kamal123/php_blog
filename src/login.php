...
<body class="text-center">
  <div class="adjustout">
    <div>
      <img class="user__avatar" src="./images/Logo.png" alt="" width="300px" />
    </div>
  </div>
  <main class="form-signin">
  <h1 class="text-dark" style="
font-family: 'Luckiest Guy', cursive; text-align: center; font-size: 2.5vw;">Login to Read/Post Blogs!!</h1>
